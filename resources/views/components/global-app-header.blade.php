<header>
    <div x-data="{ mmopen: false }">
        <nav class="bg-backgroundColor h-20 flex items-center justify-between px-4 md:px-10">
            <button type="button" id="mobile-menu-button-open" class="md:hidden" x-show="!mmopen" @click="mmopen = !mmopen">
            ...
            <button type="button" id="mobile-menu-button-close" class="md:hidden" x-show="mmopen" @click="mmopen = !mmopen">
        ...
        <div id="mobile-menu" class="absolute w-full h-auto shadow-lg bg-white" x-show="mmopen" x-transition>
